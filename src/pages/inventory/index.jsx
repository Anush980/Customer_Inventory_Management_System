...
const [snackbar,setSnackbar]= useState(null);
  ...
  const confirmDelete = async () => {
    ...
    try {
      const res = await fetch(`${process.env.REACT_APP_API_URL}/api/inventory/${deleteItem._id}`, {
        method: "DELETE",
      });
 ...
 window.location.reload();
  ...
  return (
    <Layout>
      <Pageheader title="Inventory Management" btnTitle="Add Item" variant="inventory" />
